...
root.geometry("800x600") #Ancho x alto WxH
...
etiqueta2 = ttk.Label(root,font="Helvetica 30",background="#f2f2f2",foreground="#0099cc")
etiqueta2.grid(row=1, column=0, columnspan=2)

boton = ttk.Button(root, text="Esto es un boton", padding=10) 
